...
if __name__ == "__main__":
    ...
    fitter_Mesh = os.path.join("./data", aaa_name, "fitter_mesh_large.obj")
    ...
    GHD_visualizer.visualize_GHD_fitting(frame=2, label="ED")
    # GHD_visualizer.get_growth_magnitude(frame1=1, frame2=2)
